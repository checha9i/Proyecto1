...
public class GraficadorConfig 
{
    ...
    public void graficarAST(Nodo raiz)
    {
        ...
        String ruta_dot = System.getProperty("user.home") + File.separator +"SalidasDot"+File.separator+"ast3.dot"; 
        String ruta_png = System.getProperty("user.home") + File.separator +"SalidasDot"+File.separator+"ast3.png"; 
    ...
    private void crearGrafo(String ruta_dot, String ruta_png)
    {
        ...
        {Logger.getLogger(CompiladorConfig.class.getName()).log(Level.SEVERE, null, ex);}
    }
