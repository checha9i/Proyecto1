...
Token t;
    if (jj_2_9(2)) {
      ...
      jj_consume_token(HORA);
             padre=new Nodo(Constants.HORA,0,0,"HORA");
      jj_consume_token(LlaveL);
      hijo = MUCHOS_CONTENIDOSP();
                                  padre.hijos.add(hijo);
      jj_consume_token(LlaveR);
      ...
      jj_consume_token(FECHAHORA);
                  padre=new Nodo(Constants.FECHAHORA,0,0,"FECHAHORA");
      jj_consume_token(LlaveL);
      hijo = MUCHOS_CONTENIDOSP();
                                  padre.hijos.add(hijo);
      jj_consume_token(LlaveR);
      ...
      jj_consume_token(DECIMAL);
                padre=new Nodo(Constants.DECIMAL,0,0,"DECIMAL");
      jj_consume_token(LlaveL);
      hijo = MUCHOS_CONTENIDOSP();
                                  padre.hijos.add(hijo);
      jj_consume_token(LlaveR);
      ...
      jj_consume_token(CONDICIONAL);
                 padre=new Nodo(Constants.CONDICIONAL,0,0,"CONDICIONAL");
      jj_consume_token(LlaveL);
      hijo = MUCHOS_CONTENIDOSP();
                                  padre.hijos.add(hijo);
      jj_consume_token(LlaveR);
      ...
      jj_consume_token(MULTIMEDIA);
                padre=new Nodo(Constants.MULTIMEDIA,0,0,"MULTIMEDIA");
      jj_consume_token(LlaveL);
      hijo = MUCHOS_CONTENIDOSP();
                                  padre.hijos.add(hijo);
      jj_consume_token(LlaveR);
  ...
  hijo2=new Nodo("valor", t.beginLine, t.beginColumn,t.image); padre.hijos.add(hijo2);
      ...
      jj_consume_token(SELECCIONA_MULTIPLES);
      t = jj_consume_token(ID);
                                 padre=new Nodo(Constants.SELECCIONA_MULTIPLES,0,0,"SELECCIONA_MULTIPLES");
  hijo2=new Nodo("valor", t.beginLine, t.beginColumn,t.image); padre.hijos.add(hijo2);
      jj_consume_token(LlaveL);
      hijo = MUCHOS_CONTENIDOSP();
                                  padre.hijos.add(hijo);
...
Nodo padre,hijo,hijo2;
   padre = new Nodo("VALORES",0,0,"VALORES");
    hijo = CONTENIDO_PREGUNTA();
                                padre.hijos.add(hijo);
    MUCHOS_CONTENIDOSP2(padre);
 {if (true) return padre;}
    throw new Error("Missing return statement in function");
  }

  final public Nodo MUCHOS_CONTENIDOSP2(Nodo padre) throws ParseException {
Nodo hijo,hijo2;
    if (jj_2_21(2)) {
      hijo = CONTENIDO_PREGUNTA();
                                padre.hijos.add(hijo);
...
Token t;
    if (jj_2_22(2)) {
      ...
      t = jj_consume_token(ID);
      jj_consume_token(delim);
 hijo=new Nodo("id",0,0,t.image);padre.hijos.add(hijo); {if (true) return padre;}
    } else if (jj_2_23(2)) {
 ...
 hijo=new Nodo("id",0,0,t.image);padre.hijos.add(hijo); {if (true) return padre;}
  ...
  final public Nodo ETQ() throws ParseException {
 String Cad;
Nodo padre;
Nodo aux,aux2;
  padre=new Nodo("",0,0,"concatenar");
    aux2 = T();
           padre.hijos.add(aux2);
    ETQ2(padre);
                                                {if (true) return padre;}
    throw new Error("Missing return statement in function");
  }

  final public Nodo ETQ2(Nodo padre) throws ParseException {
 String Cad;
Nodo aux,aux2;
    if (jj_2_39(2)) {
      aux = T();
 ...
 Token t;
    if (jj_2_40(2)) {
      t = jj_consume_token(Cualquiera);
                  String aux=t.image.replace("~","");aux=aux.replace("\u005c"","\u005c\u005c\u005c"");   {if (true) return new Nodo("padre ",0,0,aux + " ");}
    } else if (jj_2_41(2)) {
      jj_consume_token(Numeral);
      jj_consume_token(CorcheteL);
      t = jj_consume_token(ID);
      jj_consume_token(CorcheteR);
                                           String aux=t.image.replace("~",""); {if (true) return new Nodo("padre ",0,0,aux + " ");}
    } else if (jj_2_42(2)) {
      jj_consume_token(Punto);
           {if (true) return new Nodo("padre ",0,0,"padre");}
    } else if (jj_2_43(2)) {
      jj_consume_token(PuntoP);
            {if (true) return new Nodo("madre ",0,0,"madre");}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  private boolean jj_3_20() {
    if (jj_scan_token(SELECCIONA_MULTIPLES)) return true;
    if (jj_scan_token(ID)) return true;
    return false;
  }

  private boolean jj_3_43() {
    if (jj_scan_token(PuntoP)) return true;
    return false;
  }
  ...
  private boolean jj_3_41() {
    ...
    if (jj_scan_token(CorcheteL)) return true;
    return false;
  }
  ...
  private boolean jj_3_40() {
    if (jj_scan_token(Cualquiera)) return true;
    return false;
  }
